...
import com.mawulidev.userservice.services.UserDetailsServiceImpl;
...
//        return path.startsWith("/api/v1/users/auth/authenticate") || path.startsWith("/api/v1/users/welcome");
//    }
}
